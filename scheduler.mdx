...
Scheduler service shares the same code base with **[API](/api-reference/overview.md)** and located in the [`scheduler`](https://github.com/paralect/ship/tree/master/template/apps/api/src/scheduler) folder.  
